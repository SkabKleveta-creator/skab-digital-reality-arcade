...
Version 2.0.0 turns the original continuous-field prototype into a complete, replayable browser campaign while retaining its Canvas artwork, sword combat, one ground plane, and optional elevated routes.
